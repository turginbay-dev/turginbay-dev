...
🚀 Interested in: Web Development, Mobile Apps, Clean UI/UX

---

![snake gif](https://github.com/turginbay-dev/turginbay-dev/blob/output/github-contribution-grid-snake.svg)
...
- 📱 **Flutter App** — realtime chat + roles (Private)
- 🤖 **Telegram Bot** — automation / utilities

---

## 📸 Screenshots & Demos
> Check my pinned repositories below for screenshots, demo videos, and setup steps.

---

## 📫 Contact
- GitHub: **@turginbay-dev**
